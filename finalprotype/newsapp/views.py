...
def international_news(request):
    news_api_request = requests.get('http://newsapi.org/v2/everything?q=bitcoin&from=2020-05-29&sortBy=publishedAt&apiKey=cc35aaa7e3b54248970983cb40291f59')
    api = simplejson.loads(news_api_request.content)
    ...
    api2 = simplejson.loads(news_api_request.content)
    ...
    api3 = simplejson.loads(news_api_request.content)
